                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="/" style="display:block;margin-bottom: 20px;"
                                                                        target="_blank">
                                                                        <img alt=""
                                                                            src="https://brasol.vn/public/ckeditor/uploads/thiet-ke-logo-tin-tuc/y-nghia-logo-tiki.jpg"
                                            ...
                                            <tr>
                                                <td>
                                                    <h1
                                                        ...
                                                        Cảm ơn quý khách ${Name} đã đặt hàng tại E-Shop,</h1>
            
                                                    <p
                                                        style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal">
                                                        E-Shop rất vui thông báo đơn hàng #775914723 của quý khách đã được tiếp nhận
                                                        và
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding:3px 9px 9px 9px;border-top:0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal"
                                                                    valign="top"><span style="text-transform:capitalize">${Name}</span><br>
                                                                    <a href="mailto:huonghuongnewton@gmail.com"
                                                                        target="_blank">huonghuongnewton@gmail.com</a><br>
                                                                    0382345678
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2"
                                                                    ...
                                                                    <p
                                                                        style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal">
                                                                        <strong>Phương thức thanh toán: </strong> Thanh toán tiền
                                                                        mặt
                                                                        khi nhận hàng<br>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="background:#f5f5f5"
                                                        ...
                                                        <tbody bgcolor="#eee"
                                                            ...
                                                            <#list orders as order>
															 	<tr>
	                                                                <td align="left" style="padding:3px 9px" valign="top"><span>${order.name}</span><br>
	                                                                </td>
                                                        ...
                                                        <tfoot
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" style="padding:5px 9px"><span>${total_noship}</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right" colspan="4" style="padding:5px 9px">Phí vận chuyển
                                                                </td>
                                                                <td align="right" style="padding:5px 9px"><span>${ship_fee}</span></td>
                                                            </tr>
                                                            <tr bgcolor="#eee">
                                                                ...
                                                                <td align="right" style="padding:7px 9px">
                                                                    <strong><big><span>${total}</span> </big> </strong>
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                    ...
                                                    <div style="margin:auto">
                                                        <a href="http://localhost:3000/customer/order/history/detail/15"
